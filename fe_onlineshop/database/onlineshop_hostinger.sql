...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `display_promo_products`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `display_promo_products` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `display_promo_id` int(10) unsigned NOT NULL,
  `product_id` int(10) unsigned NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `display_promos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `display_promos` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `admins` VALUES (1,1,'Admin Ayres','admin@ayres.com','$2b$10$pv4ntgtpcuhyqM2XmyAlz.qvknDBlP8lrTx95H4SDnQr3uwR9Y2Ce',1,'2026-06-12 03:08:44','2026-04-13 08:34:31','2026-06-12 03:08:44');
